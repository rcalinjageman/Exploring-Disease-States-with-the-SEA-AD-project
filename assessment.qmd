...
Overall, completing the activity produced large gains in knowledge related to the learning objectives:
...
![](images/Pre_Post_Overall.png)

![Changes in Quiz Scores by Institution](images/Pre_Post_By_School.png)

![Activity feedback distributions by item and institution](images/Feedback_Distribution.png){fig-alt="Activity feedback distributions by item and institution"}

![Change in probability of highest confidence by item and institution](images/Model_Plot_Ratings.png){fig-alt="Change in probability of highest confidence by item and institution"}
